...
<body>
            ...
            <div class="col-lg-6 col-6 text-left">
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Pesquise por Servicos">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{('service')}}" class="nav-item nav-link active">Inicio</a>
                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <a href="" class="btn btn-light py-2 px-3">Solicite um orçamento</a>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid bg-secondary mb-5"  style="background-image: url('img/slider/slider3.jpg');">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Solicitação de Serviços </h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="">Inicio</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">solicitação de serviços</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row px-xl-5">
                       ...
                       <!--<div class="col-md-6 form-group">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="newaccount" >Aceitar todos termos e condicoes</label>
                            </div>
                        </div>
                        <div class="col-md-12 form-group">
                            <div class="custom-control custom-checkbox">
            ...
            <div class="col-lg-4">
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <h5 class="font-weight-medium mb-3">Serviços</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="directcheck">Mpesa</label>
                            </div>
                        </div>
                        <div class="">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="banktransfer">
                                <label class="custom-control-label" for="banktransfer">Emola</label>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer border-secondary bg-transparent">
                        <button class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">Faça o pedido</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold" href="#">k-imagem</a>. Todos Direitos Reservados. Desenhado pela

                    <a class="text-dark font-weight-semi-bold" href="https://htmlcodex.com">explicador</a>
                </p>
            </div>
